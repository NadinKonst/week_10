...
function hello(guestName = "Гость") {
...
console.log(
  "Моему другу сейчас " + calculateAge(currentYear, friendYearOfBirth) + " лет"
);
//Задание 17
...
console.log("Мне сейчас " + calculateAge(currentYear, myYearOfBirth) + " год");
//Задание 18
...
console.log("Результат: " + calculate(2, 3));
